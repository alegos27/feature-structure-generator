...
mixin _$TemplateState {
  NotifierStatus get status => throw _privateConstructorUsedError;
...
abstract class $TemplateStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({NotifierStatus status});
}
...
class _$TemplateStateImpl extends _TemplateState {
  const _$TemplateStateImpl({this.status = NotifierStatus.loading}) : super._();
...
abstract class _TemplateState extends TemplateState {
  const factory _TemplateState({final NotifierStatus status}) =
      _$TemplateStateImpl;
  const _TemplateState._() : super._();

  @override
  NotifierStatus get status;
  @override
  @JsonKey(ignore: true)
  _$$TemplateStateImplCopyWith<_$TemplateStateImpl> get copyWith =>
      throw _privateConstructorUsedError;
